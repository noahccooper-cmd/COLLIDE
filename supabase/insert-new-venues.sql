...
-- Upserts all 10 Knoxville venues with verified coordinates
-- Run seed-all-venues.sql instead for a cleaner version
-- =============================================
...
-- Step 4: Upsert all 10 venues with VERIFIED coordinates
